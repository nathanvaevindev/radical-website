...
const FOUNDERS = [
  {
    ...
    phoneDisplay: "+31 6 43 79 11 17",
    phoneHref: "+31643791117",
  ...
  },
  {
    ...
    phoneDisplay: "+31 6 43 02 98 98",
    phoneHref: "+31643029898",
    photoUrl: "/oscar.png",
  },
];
          ...
          {FOUNDERS.map((f, i) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                <a
                  href={`mailto:${f.email}`}
                  className="mt-3 block text-sm text-smaragd transition-colors duration-150 hover:text-smaragd-light"
                >
                  {f.email}
                </a>
                <a
                  href={`tel:${f.phoneHref}`}
                  className="mt-1 block text-sm text-smaragd transition-colors duration-150 hover:text-smaragd-light"
                >
                  {f.phoneDisplay}
                </a>
              </div>
